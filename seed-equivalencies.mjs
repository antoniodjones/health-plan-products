/**
 * Equivalency Seed Script (ESM)
 * Run with: node seed-equivalencies.mjs
 */
...
async function main() {
  ...
  console.log(`  ✓ Equivalency: ${hba1cEquiv.name}`);
  ...
  console.log(`  ✓ Equivalency: ${lipidEquiv.name}`);
  ...
  console.log(`  ✓ Equivalency: ${officeVisitEquiv.name}`);
