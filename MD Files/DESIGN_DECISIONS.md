# Design Decisions - Products & Benefits Platform

Product Requirements
All code must be attached to a Jira ticket, and the code that makes the changes will have a link to the Github repo.
...
### Naming Conventions
- **Meaningful Names**: Use intention-revealing names (no abbreviations or acronyms that) explain purpose without comments
