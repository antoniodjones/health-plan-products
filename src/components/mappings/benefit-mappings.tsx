/**
 * Benefit Mappings Component
 * Original Code-to-Benefit mappings functionality
 */
'use client';
...
import { CreateBenefitMappingDialog } from './create-benefit-mapping-dialog';
...
export function BenefitMappings() {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3 rounded-lg border bg-gray-50 px-4 py-3">
                      ...
                      <div>
                        <p className="font-mono text-sm font-semibold text-gray-900">{mapping.codeSet?.code}</p>
                        {mapping.codeSet && (
                          <CodeTypeBadge codeType={mapping.codeSet.codeType as any} showIcon={false} />
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 rounded-lg border bg-blue-50 px-4 py-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-gray-900">{mapping.benefitSegment?.name}</p>
                        {mapping.benefitSegment?.category && (
                          <p className="text-xs text-gray-600">{mapping.benefitSegment.category}</p>
                        )}
                      </div>
                    </div>
